// Testing component children

/**
 * Testing the children prop is very straightforward. We just need to
 * make sure that the passed value matches the result rendered:
 */
...
function VisibilityToggler({ children }) {
